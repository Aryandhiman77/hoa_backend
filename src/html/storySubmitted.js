const storySubmitted = (name = "there") => {
  return `
    <!DOCTYPE html>
    <html>
      <head>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="max-width:600px; background:#ffffff; border-radius:16px; overflow:hidden; box-shadow:0 8px 30px rgba(0,0,0,0.08);">
                ...
                <tr>
                  <td align="center" style="padding:30px 25px 15px;">
                    <img src=${process.env.APP_URL + "hoa-logo.png"} alt="Website Logo" style="max-width:150px; height:auto;" />
                  </td>
                </tr>
                ...
                <tr>
                  <td style="padding:10px 35px 0;">
                    ...
                    <p style="margin:14px 0 0; color:#4b5563; font-size:16px; line-height:1.7;">
                      Thank you for submitting your story. We have received it successfully.
                    </p>

                    <p style="margin:14px 0 0; color:#4b5563; font-size:16px; line-height:1.7;">
                      Our team will review your submission before it is published. If we need any more details, we will contact you using the email address you provided.
                    </p>
                  </td>
                </tr>
                  ...
                  <td style="padding:22px 35px 10px;">
                    <div style="background:#f0fdf4; border:1px solid #bbf7d0; border-radius:12px; padding:16px;">
                      <p style="margin:0; color:#166534; font-size:15px; line-height:1.6;">
                        Your story is now in review. Please allow our team some time to check it.
                      </p>
                    </div>
                  </td>
                </tr>
