              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="max-width:600px; background:#ffffff; border-radius:16px; overflow:hidden; box-shadow:0 8px 30px rgba(0,0,0,0.08);">
                ...
                <tr>
                  <td style="padding:10px 35px 0;">
                    ...
                    <p style="margin:14px 0 0; color:#4b5563; font-size:16px; line-height:1.7;">
                      Good news. Your submitted story, <strong>${storyTitle}</strong>, has been reviewed and approved by our admin team.
                    </p>

                    <p style="margin:14px 0 0; color:#4b5563; font-size:16px; line-height:1.7;">
                      Thank you for sharing your experience with us. Your story can help others understand similar HOA-related situations.
                    </p>
                  </td>
                </tr>
                  ...
                  <td style="padding:22px 35px 10px;">
                    <div style="background:#f0fdf4; border:1px solid #bbf7d0; border-radius:12px; padding:16px;">
                      <p style="margin:0; color:#166534; font-size:15px; line-height:1.6;">
                        Status: Approved. Your story is now ready to be published or shown on the website based on admin settings.
                      </p>
                    </div>
                  </td>
                </tr>
                ...
                <tr>
                  <td align="center" style="padding:25px 35px 35px;">
                    <a href="${storyUrl}" style="display:inline-block; background:#0f766e; color:#ffffff; text-decoration:none; padding:13px 26px; border-radius:8px; font-size:15px; font-weight:600;">
                      View Story
                    </a>
                  </td>
                </tr>
