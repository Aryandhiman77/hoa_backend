                ...
                <tr>
                  <td style="padding:10px 35px 0;">
                    ...
                    <p style="margin:14px 0 0; color:#4b5563; font-size:16px; line-height:1.7;">
                      Great news. Your story, <strong>${storyTitle}</strong>, has been approved and published on our website.
                    </p>

                    <p style="margin:14px 0 0; color:#4b5563; font-size:16px; line-height:1.7;">
                      Thank you for sharing your experience. Your story may help other homeowners understand similar HOA situations.
                    </p>
                  </td>
                </tr>
                  ...
                  <td style="padding:22px 35px 10px;">
                    <div style="background:#f0fdf4; border:1px solid #bbf7d0; border-radius:12px; padding:16px;">
                      <p style="margin:0; color:#166534; font-size:15px; line-height:1.6;">
                        Status: Published. Your story is now live on the website.
                      </p>
                    </div>
                  </td>
                </tr>
